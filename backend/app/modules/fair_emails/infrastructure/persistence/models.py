...
# Backwards-compatible import name. Fair bulk email recipients now live directly
# in mail_send_operations, which is the single source of truth for delivery state.
from app.modules.mail_send_operations.infrastructure.persistence.models import (  # noqa: E402
    MailSendOperationModel as FairEmailOutboxModel,
)
