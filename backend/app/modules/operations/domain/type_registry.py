...
OPERATION_TYPE_DEFINITIONS: dict[str, OperationTypeDefinition] = {
    ...
    OperationType.DUPLICATE_CHECK: OperationTypeDefinition(
        ...
        wizard_steps=(
            WizardStepDefinition(id="type_config", required=True, order=1),
            WizardStepDefinition(id="summary", required=True, order=2),
        ),
        type_config_schema={"fields": ["job_key", "group_by", "data_operation_run_id"]},
        run_settings_schema={"fields": ["priority"]},
    ),
