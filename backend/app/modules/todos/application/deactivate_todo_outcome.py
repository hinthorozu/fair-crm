...
from app.modules.todos.application.outcome_commands import DeactivateTodoOutcomeCommand, TodoOutcomeResult
...
class DeactivateTodoOutcomeUseCase:
    ...
    def execute(self, command: DeactivateTodoOutcomeCommand) -> TodoOutcomeResult:
        ...
        self._audit.record_event(
            organization_id=command.organization_id,
            access_token=command.access_token,
            action="fair_crm.todo_outcome.deactivated",
