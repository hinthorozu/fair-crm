...
def _to_response(item: MailSendOperationListItem) -> MailSendOperationListItemResponse:
    ...
    return MailSendOperationListItemResponse(
        ...
        email_account_name=item.email_account_name,
...
def list_mail_send_operations(
    ...
    email_account_id: Annotated[UUID | None, Query()] = None,
    ...
    filters = {
        ...
        for key, value in {
            ...
            "status": status,
            "source_type": source_type,
            "email_account_id": str(email_account_id) if email_account_id else None,
