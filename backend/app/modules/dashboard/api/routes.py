...
from app.modules.dashboard.api.dependencies import get_dashboard_summary_use_case, require_dashboard_access
...
def get_dashboard_summary(
    auth: Annotated[AuthContext, Depends(require_dashboard_access)],
