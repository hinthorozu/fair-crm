...
from app.modules.fairs.application.commands import ArchiveFairCommand, FairResult
...
class ArchiveFairUseCase:
    ...
    def execute(self, command: ArchiveFairCommand) -> FairResult:
