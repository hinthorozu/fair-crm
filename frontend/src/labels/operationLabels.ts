...
export const operationLabels = {
  ...
  bulkEmailExcelHint: "Yalnızca .xlsx dosyası. 1. kolon Alıcı/Firma adı, 2. kolon e-posta.",
  bulkEmailExcelFormatTitle: "Excel Dosya Formatı",
  bulkEmailExcelFormatIntro: "Excel dosyasında:",
  bulkEmailExcelFormatCol1: "1. kolon: Mailin gönderileceği kişi veya firmanın adı",
  bulkEmailExcelFormatCol2: "2. kolon: E-posta adresi",
  bulkEmailExcelFormatExampleHeading: "Örnek:",
  bulkEmailExcelFormatColNameHeader: "Alıcı / Firma Adı",
  bulkEmailExcelFormatColEmailHeader: "E-posta",
  bulkEmailExcelFormatGotIt: "Anladım",
  ...
  bulkEmailSkipReasonCustomerConsent: "Customer e-posta iletişim izni kapalı",
  bulkEmailSkipReasonContactConsent: "Contact e-posta iletişim izni kapalı",
  bulkEmailSummaryCustomerConsentSkipped: "Customer izni nedeniyle hariç",
  bulkEmailSummaryContactConsentSkipped: "Contact izni nedeniyle hariç",
