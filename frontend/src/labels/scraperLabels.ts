export const scraperLabels = {
  ...
  testNoLogsYet: "Henüz log kaydı yok.",
  ...
  runStatusCancelRequested: "Çalışıyor",
  runStatusCancelling: "Çalışıyor",
  runStatusCompleted: "Bitti",
  runStatusFailed: "Hata",
  runStatusCancelled: "İptal",
  ...
  runHistoryHideDetails: "Detayları Gizle",
  runHistoryTechnicalDetails: "Teknik detaylar",
  ...
  enrichmentRunFairAlreadySelected: "Bu fuar zaten seçili.",
  enrichmentRunFairPlural: "Fuarlar",
  enrichmentSourceSectionTitle: "Kaynak",
