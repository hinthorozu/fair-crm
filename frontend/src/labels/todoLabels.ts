...
export const todoLabels = {
  ...
  customerReadPermissionRequired: "Müşteri seçimini görüntülemek veya değiştirmek için müşteri görüntüleme yetkisi gerekir.",
  ...
  fairReadPermissionRequired: "Fuar seçimini görüntülemek veya değiştirmek için fuar görüntüleme yetkisi gerekir.",
  entityReadPermissionRequired: "Bu görev kategorisi için gerekli müşteri ve fuar seçimlerini yapabilmek üzere ilgili görüntüleme yetkileri gerekir.",
  fieldCustomerNone: "—",
  fieldSourceFairNone: "—",
