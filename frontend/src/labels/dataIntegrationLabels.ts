export const dataIntegrationLabels = {
  ...
  colAdapter: "Adapter",
  colStatus: "Durum",
  colAnalysisStatus: "Analiz Durumu",
  colLastAnalyzed: "Son Analiz",
  colRows: "Satır",
  colCreated: "Oluşturulma",
  colActions: "İşlemler",
  analysisStatusAnalyzed: "Analiz Edildi",
  analysisStatusNotAnalyzed: "Analiz Edilmedi",
  openDetail: "Detay",
  continueBatch: "Devam Et",
  analyzeBatch: "Analiz Yap",
  analyzeBatchRunning: "Analiz ediliyor…",
  analyzeBatchFailed: "Analiz başlatılamadı veya başarısız oldu.",
  analyzeBatchTimeout: "Analiz zaman aşımına uğradı.",
  reanalyzeBatch: "Yeniden Analiz Et",
  reanalyzeBatchRunning: "Yeniden analiz ediliyor…",
  reanalyzeBatchSuccess: "Analiz tamamlandı. Devam Et ile güncel karar ekranını açabilirsiniz.",
  deleteBatch: "Sil",
