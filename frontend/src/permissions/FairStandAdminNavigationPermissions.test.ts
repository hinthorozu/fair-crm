...
describe("Fair Stand admin navigation", () => {
  it("shows catalog, items, preview, and settings admin only with SYSTEM Fair Stand permissions", () => {
    ...
    expect(canAccessAdminSection("fair-stand-item-types", granted)).toBe(true);
    expect(canAccessAdminSection("fair-stand-rule-types", granted)).toBe(true);
    expect(canAccessAdminSection("fair-stand-rules", granted)).toBe(true);
    ...
    expect(canAccessApplicationPath("/admin/fair-stand/item-types", granted)).toBe(true);
    expect(canAccessApplicationPath("/admin/fair-stand/rule-types", granted)).toBe(true);
    expect(canAccessApplicationPath("/admin/fair-stand/rules", granted)).toBe(true);
  ...
  it("hides Fair Stand admin from organization catalog readers", () => {
    ...
    expect(canAccessAdminSection("fair-stand-item-types", granted)).toBe(false);
    expect(canAccessAdminSection("fair-stand-rule-types", granted)).toBe(false);
    expect(canAccessAdminSection("fair-stand-rules", granted)).toBe(false);
    ...
    expect(canAccessApplicationPath("/admin/fair-stand/item-types", granted)).toBe(false);
    expect(canAccessApplicationPath("/admin/fair-stand/rules", granted)).toBe(false);
