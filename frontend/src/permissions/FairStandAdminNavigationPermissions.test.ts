...
describe("Fair Stand admin navigation", () => {
  it("shows catalog, preview, and settings admin only with SYSTEM Fair Stand permissions", () => {
    const granted = [FAIR_STAND_CATALOG_READ, FAIR_STAND_PREVIEWS_READ, FAIR_STAND_SETTINGS_READ];
