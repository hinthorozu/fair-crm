...
export interface Quote {
  ...
  template_id: string; quote_date: string; status: "draft" | "given";
  selected_items: QuoteSelectedItem[]; created_at: string; updated_at: string;
}
export interface QuotePayload { template_id: string; quote_date: string; status: "draft" | "given"; selected_items: QuoteSelectedItem[] }
